...
from keras.layers import Conv2D, Activation, Input, Add, MaxPooling2D, Flatten, Dense, Dropout, BatchNormalization, \
    Concatenate, Lambda, add, GlobalAveragePooling2D, Convolution2D, LocallyConnected2D, ZeroPadding2D, concatenate, \
    AveragePooling2D
...
def InceptionResNetV2():
    ...
    branch_1 = Conv2D(96, 3, strides=2, padding='valid', use_bias=False, name='Conv2d_3a_b1_3x3')(x)
    branch_1 = BatchNormalization(axis=3, momentum=0.995, epsilon=0.001, scale=False,
                                  name='Conv2d_3a_b1_3x3_BatchNorm')(branch_1)
    branch_1 = Activation('relu', name='Conv2d_3a_b1_3x3_Activation')(branch_1)
    branches = [branch_0, branch_1]
    mixed = Concatenate(axis=3, name='Stem_1_Concatenate')(branches)

    # TODO Continue Construct Inception-ResNetv2 on tensorflow, code available already in PyTorch
