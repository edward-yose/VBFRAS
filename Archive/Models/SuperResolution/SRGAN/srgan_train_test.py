...
def build_vgg(hr_shape):
    # TODO: URGENT | Fix Mismatch Shape
    weight = f'../../../Models/Saved/facenet_keras_weights.h5'
    vgg = VGG19(weights=weight, include_top=False, input_shape=hr_shape)
...
def main():
    ...
    n = 4000  # pool up to n-th images to train test data
