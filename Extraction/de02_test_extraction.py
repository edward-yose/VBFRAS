...
'''
Config:
Video 1 : every 10 seconds (240 Frames) | 30 Minutes
Video 2 : every 10 seconds (240 Frames) | 30 Minutes
Video 3 : every 10 seconds (300 Frames) | 30 Minutes
'''

# CAP SKIP FOR EXCLUDE TEST DATASET
MINUTES_SKIP = 30
